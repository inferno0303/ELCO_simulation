...
class WorkloadPrioritySchedulingLP:
    def __init__(self, ss: SystemState):
        ...
        # 统计每个SEC服务器上 offloading 函数负载总量
        self.sec_total_workload = dict.fromkeys([sec.id for sec in self.ss.get_sec_list()], 0.0)
    ...
    def try_assign(self, func: FunctionTask, sec: SECServer) -> bool:
        ...
        cr_ik = RATIO * S_k * c_i / (self.sec_total_workload[sec.id] + c_i)
        # if cr_ik < 128 * RATIO:
        #     return False
        ...
        self.sec_total_workload[sec.id] += c_i
        ...
        for func in self.ss.get_function_list():
            ...
            if self.sp.strategy[func.id]['offloading'] == 0:
                ...
                if target_id == loc_sec.id:
                    ...
                    c_i = func.invocations * func.workload
                    cr_ik = RATIO * S_k * c_i / self.sec_total_workload[loc_sec.id]
                ...
                # 策略3：协作 SEC
                    ...
                    c_i = func.invocations * func.workload
                    cr_ik = RATIO * S_k * c_i / self.sec_total_workload[target_sec.id]
